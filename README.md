...
- `artifacts/Overcooked2-MenuManager-v1.1.5.zip`
- `artifacts/Overcooked2-MenuManager-v1.1.5-symbols.zip`
- `artifacts/Overcooked2-MenuManager-v1.1.5-SHA256SUMS.txt`
...
Pushes and pull requests run CI without publishing a release. A tag must exactly match `PluginMetadata.Version`—currently `v1.1.5`—before the release workflow will publish the two validated zip files and their SHA256 checksum manifest.
