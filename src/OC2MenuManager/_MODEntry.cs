...
namespace OC2MenuManager
{
    ...
    public class _MODEntry : BaseUnityPlugin
    {
        ...
        private static void InitializeSettingsConfig()
        {
            ...
            string oldStandaloneConfigPath = Path.Combine(Paths.ConfigPath, PluginMetadata.Guid + ".standalone.cfg");
            string oldLegacyConfigPath = Path.Combine(Paths.ConfigPath, PluginMetadata.Guid + ".cfg");
            ...
            UserDataMigration.CopyFirstExistingWhenDestinationMissing(
                ...
                new string[] { oldStandaloneConfigPath, legacyConfigPath, oldLegacyConfigPath });
